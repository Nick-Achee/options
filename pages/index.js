...
<div className="p-2">
  <a className="relative inline-block text-xl font-prag font-bold text-black group active:text-black focus:outline-none focus:ring" href="https://nickachee.xyz">
  <span className="absolute inset-0 transition-transform translate-x-1 translate-y-1 bg-black group-hover:translate-y-0 group-hover:translate-x-0"></span>

  <span className="relative  block px-4 py-3 bg-white border-2 border-current">
  Digital Strategy<span aria-hidden="true" className="ml-2" role="img">🎯</span>
    
  </span>
</a></div><div className="p-2">
<a className="relative inline-block text-xl font-prag font-bold text-black group active:text-black focus:outline-none focus:ring" href="https://susanchase.com/agents/nick-achee">
  <span className="absolute inset-0 transition-transform translate-x-1 translate-y-1 bg-black group-hover:translate-y-0 group-hover:translate-x-0"></span>
